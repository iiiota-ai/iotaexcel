...
try {
  ...
  Write-Host "[1/14] Generate Excel fixtures"
  ...
  Write-Host "[2/14] Export self-describing .bytes files"
  ...
  Write-Host "[3/14] Decode self-describing .bytes files to JSON"
  ...
  Write-Host "[4/14] Decode self-describing .bytes files to CSV"
  ...
  Write-Host "[5/14] Export non-self-describing .bytes files"
  ...
  Write-Host "[6/14] Decode non-self-describing .bytes files to JSON"
  ...
  Write-Host "[7/14] Decode non-self-describing .bytes files to CSV"
  ...
  Write-Host "[8/14] Generate C# code"
  ...
  Write-Host "[9/14] Generate Go code"
  ...
  Write-Host "[10/14] Generate C++ code"
  ...
  Write-Host "[11/14] Generate Java code"
  ...
  Write-Host "[12/14] Generate JavaScript code"
  ...
  Write-Host "[13/14] Generate Python code"
  ...
  Write-Host "[14/14] Generate Swift code"
  Invoke-Checked { & $goExe run ./cmd/iotaexcel codegen --input tests/testdata/excels/valid --output out/codegen/swift --lang swift --check-ref --overwrite --log-level info } "Generate Swift code"
  ...
  Write-Host "Swift output: out/codegen/swift"
} finally {
  Pop-Location
  Wait-BeforeExit
}
